...
{   
    ...
    //f_color = CalcDirLight(dirLight, f_in.normal, viewDir);
    //f_color = vec4(CalcDirLight(dirLight, f_in.normal, viewDir), 1.0f);
    //f_color += CalcPointLight(pointLights, f_in.normal,f_in.position, viewDir);
    //f_color += CalcSpotLight(spotLight, f_in.normal, f_in.position, viewDir);
    //f_color = vec4(CalcSpotLight(spotLight, f_in.normal, f_in.position, viewDir), 1.0f);
